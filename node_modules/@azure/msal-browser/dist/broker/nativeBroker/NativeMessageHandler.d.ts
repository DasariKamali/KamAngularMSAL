import { Logger, AuthenticationScheme, IPerformanceClient, ICrypto } from "@azure/msal-common";
...
export declare class NativeMessageHandler {
    ...
    constructor(logger: Logger, handshakeTimeoutMs: number, performanceClient: IPerformanceClient, crypto: ICrypto, extensionId?: string);
    /**
     ...
     */
    static createProvider(logger: Logger, handshakeTimeoutMs: number, performanceClient: IPerformanceClient, crypto: ICrypto): Promise<NativeMessageHandler>;
    /**
